...
func (x *IsAdminRespone) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdminRespone) ProtoMessage() {}

func (x *IsAdminRespone) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdminRespone.ProtoReflect.Descriptor instead.
func (*IsAdminRespone) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{5}
}

func (x *IsAdminRespone) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\fLoginRespone\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\")\n" +
	"\x0eIsAdminRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\"+\n" +
	"\x0eIsAdminRespone\x12\x19\n" +
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*LoginRespone)(nil),     // 3: auth.LoginRespone
	(*IsAdminRequest)(nil),   // 4: auth.IsAdminRequest
	(*IsAdminRespone)(nil),   // 5: auth.IsAdminRespone
}
var file_sso_sso_proto_depIdxs = []int32{
	...
	3, // 4: auth.Auth.Login:output_type -> auth.LoginRespone
	5, // 5: auth.Auth.IsAdmin:output_type -> auth.IsAdminRespone
